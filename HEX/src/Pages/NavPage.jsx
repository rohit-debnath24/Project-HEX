            ...
            <div className=" flex flex-cols-3 gap-0 mt-10 ">
                ...
                <div className=" w-screen border-2 bg-[#100A06]">
                    ...
                    <div className="  flex justify-center">
                        ...
                        <div className=" mt-4 flex text-center pl-8 pr-8  justify-center md:text-3xl text-amber-500 break-all pt-0">
                            Hex allows teams to work together across one platform making it easy to find answer in your data-share them with stakeholders, and make decisions with , confidence.
                        </div>
                    ...
                    <div className="flex justify-center">
                        <div className=" grid grid-cols-2 absolute md:top-542 lg:top-362 top-642 border-dotted w-70  md:w-200 h-15 md:h-25 border-b-2 border-red-800 z-[] ">
                    ...
                    <div className="flex justify-center">
                            <div className="absolute top-654 md:top-562 lg:top-382 bg-black border-dotted text-orange-300 border-2 text-[10px] md:text-[20px] border-red-800">UNDERLYING HEX PLATFORM</div>
                    </div>
