                        ...
                        <div class="md:h-[448px] sm:grid grid grid-cols-[8px_1fr_8px] sm:grid-cols-[26px_1fr_26px]">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 md:ml-10 md:mr-10">
                                <div class="m-4 rounded-lg  h-[410px] md:h-[516px] grid grid-rows-4 "><div className='p-3'><div className='text-2xl sm:text-3xl text-amber-100 font-medium'>Explore with point and click no code tools</div><div className='text-amber-700'>Hex makes it easier to code implement and deploy your code with ease </div></div>
                                    <div class="row-span-3 hover:scale-105 shadow-green-600/50 duration-300 hover:shadow-xl row-start-2 mt-6 sm:mt-2 m-3 sm:m-4  bg-cover rounded-lg overflow-hidden" style={{ backgroundImage: `url(${bgImg})` }}><img src="https://image.freepik.com/free-photo/stock-market-forex-trading-graph-graphic-concept_73426-102.jpg" className=' pt-20 sm:pt-26 '></img> </div>
                                </div>
                                <div class="m-4 rounded-lg  h-[410px] md:h-[516px] grid grid-rows-4 "><div className='p-3'><div className='text-2xl sm:text-3xl text-amber-100 font-medium'>Explore with point and click no code tools</div><div className='text-amber-700'>Hex makes it easier to code implement and deploy your code with ease </div></div>
                                    <div class="row-span-3 hover:scale-105 shadow-green-600/50 duration-300 hover:shadow-xl row-start-2 mt-6 sm:mt-2 m-3 sm:m-4  bg-cover rounded-lg overflow-hidden" style={{ backgroundImage: `url(${bgImg})` }}><img src="https://i.pinimg.com/736x/ec/31/fb/ec31fb6bb86683cf4d2d1680f79f14cb.jpg" className='bg-cover h-fullw-full pt-20 sm:pt-26 '></img> </div>
                                </div>
                                <div class="m-4 rounded-lg  h-[410px] md:h-[516px] grid grid-rows-4 "><div className='p-3'><div className='text-2xl sm:text-3xl text-amber-100 font-medium'>Explore with point and click no code tools</div><div className='text-amber-700'>Hex makes it easier to code implement and deploy your code with ease </div></div>
                                    <div class="row-span-3  hover:scale-105 shadow-green-600/50 duration-300 hover:shadow-xl row-start-2 mt-6 sm:mt-2 m-3 sm:m-4  bg-cover rounded-lg overflow-hidden" style={{ backgroundImage: `url(${bgImg})` }}><img src="https://i.pinimg.com/736x/52/e1/77/52e177276388a34e067773436d3a98a4.jpg" className=' pt-20 sm:pt-26 '></img> </div>
                                </div>
