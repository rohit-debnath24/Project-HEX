                ...
                <div class="h-screen">
                    <div class="h-[200px] border grid mt-8 mb-8 grid-cols-[8px_1fr_8px] border-black sm:grid sm:grid-cols-[26px_1fr_26px]">
                        ...
                        <div class=" grid sm:grid-cols-2 sm:grid-rows-4 ">
                            ...
                            <div className='sm:col-start-1 sm:col-span-1 sm:row-span-3 text-3xl sm:text-5xl font-medium text-amber-300 '>Fast,flexible and collaborative analytics</div>
                            <div className='sm:col-start-2 sm:col-span-1 sm:row-span-4 sm:text-xl sm:font-medium  text-amber-600'>Hex's notebooks are built for the analyses that actually matter. With<br/> an integrated toolkit, you no longer need to jump between tools to <br/>query, predict, transform, and visualize data.</div>
                ...
                <div class="md:h-[550px] ">
                    ...
                    <div class="md:h-[448px] sm:grid grid grid-cols-[8px_1fr_8px] sm:grid-cols-[26px_1fr_26px]">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 md:ml-10 md:mr-10">
                            ...
                            {/* <div class="m-4 rounded-lg  h-[450px] md:h-[516px] grid grid-rows-4 "><div className='p-3'><div className='text-2xl sm:text-3xl text-amber-100 font-medium'>Explore with point and click<br/> no code tools</div><div className='text-amber-700'>Hex makes it easier to code implement and deploy your code with ease </div></div>
                                <div class="row-span-3 row-start-2 m-2  bg-cover rounded-lg overflow-hidden" style={{backgroundImage:`url(${bgImg})`}}><img src="https://image.freepik.com/free-photo/stock-market-forex-trading-graph-graphic-concept_73426-102.jpg" className='pt-22 '></img> </div>
                            </div>
                            <div class="m-4 rounded-lg  h-[450px] md:h-[516px] grid grid-rows-4 "><div className='p-3'><div className='text-2xl sm:text-3xl text-amber-100 font-medium'>Explore with point and click<br/> no code tools</div><div className='text-amber-700'>Hex makes it easier to code implement and deploy your code with ease </div></div>
                                <div class="row-span-3 row-start-2 m-2  bg-cover rounded-lg overflow-hidden" style={{backgroundImage:`url(${bgImg})`}}><img src="https://image.freepik.com/free-photo/stock-market-forex-trading-graph-graphic-concept_73426-102.jpg" className='pt-22 '></img> </div>
                            </div> */}
                            {/* <div class="m-4 rounded-lg  h-[300px] md:h-[516px] grid grid-rows-4 "><div className='p-3'><div className='text-3xl text-amber-100 font-medium'>Explore with point and click<br/> no code tools</div><div className='text-amber-700'>Hex makes it easier to code implement and deploy your code with ease </div></div>
                                <div class="row-span-3 row-start-2 m-2  bg-cover rounded-lg overflow-hidden" style={{backgroundImage:`url(${bgImg})`}}><img src="https://image.freepik.com/free-photo/stock-market-forex-trading-graph-graphic-concept_73426-102.jpg" className='pt-22 '></img> </div>
                            </div>
                            <div class="m-4 rounded-lg  h-[300px] md:h-[516px] grid grid-rows-4 "><div className='p-3'><div className='text-3xl text-amber-100 font-medium'>Explore with point and click<br/> no code tools</div><div className='text-amber-700'>Hex makes it easier to code implement and deploy your code with ease </div></div>
                                <div class="row-span-3 row-start-2 m-2  bg-cover rounded-lg overflow-hidden" style={{backgroundImage:`url(${bgImg})`}}><img src="https://image.freepik.com/free-photo/stock-market-forex-trading-graph-graphic-concept_73426-102.jpg" className='pt-22 '></img> </div>
