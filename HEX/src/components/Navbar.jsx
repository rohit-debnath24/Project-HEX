        ...
        <>
            ...
            <div className={`${sticky ? 'fixed top-0 left-0 right-0 shadow-md bg-[#100A06] z-50' : 'relative'} 
                ...
                <div className="h-14 border-1 border-[#564b45ca] w-screen mt-2 md:mt-4 py-2 flex justify-center gap-7 ">
                    ...
                    <div
                        className="text-[#e3b2b3] md:hidden flex ml-auto text-2xl w-10 h-10 text-center justify-center border border-[#564b45ca] rounded-full rotate-90 font-light cursor-pointer"
                        onClick={
                            () => {
                                setIsOpen(!isOpen);
                            }
                ...
                <div className={`absolute top-16 h-[100vh] w-screen  bg-black z-100  overflow-y-scroll   text-amber-50 md:hidden grid grid-cols-1 ${isOpen ? "opacity-100" : "opacity-0"} `}>
                    ...
                    <div className=" grid grid-cols-1 h-[58vh]  border-b-2 border-amber-100 border-dashed ">
                        ...
                        <div className="col-span-1 h-2 w-screen  text-[15px] font-serif pl-4 p-4"># Notebooks</div>
                        <div className="col-span-1 h-2 w-screen  text-[15px] font-serif pl-4 p-4"># Data Apps</div>
                        ...
                        <div className="col-span-1 h-2 w-screen  text-[15px] font-serif pl-4 p-4"># Trusted data</div>
                        <div className="col-span-1 h-2 w-screen  text-[15px] font-serif pl-4 p-4"># Analysis</div>
                        <div className="col-span-1 h-2 w-screen  text-[15px] font-serif pl-4 p-4"># Collaborative Intelligence</div>
                        <div className="col-span-1 h-2 w-screen  text-[15px] font-serif pl-4 p-4"># Instant Integration</div>



                    </div>
                    <div className=" grid grid-cols-1 h-[38vh]  border-b-2 border-amber-100 border-dashed ">
                        <div className="col-span-1 row-span-1 w-screen  text-[10px]  text-amber-700/50 font-serif pl-4 mt-2 ">PLATFORM</div>
